...
public class TileList
{
	...
	/**
	 * Export in format interpretable by prism/etc/scripts/pareto-plot.py
	 * @return {@linkl String} that represents the pareto curve
	 */
	...
	{
		storedFormulas.add(List.of(formula));
	 ...
	 */
	protected void splitTilesByPoint(Point point, boolean isRealyFoundPoint)
	{
