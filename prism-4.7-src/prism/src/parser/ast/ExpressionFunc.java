...
public class ExpressionFunc extends Expression
{
	...
	public static final int MLESSMULTI = 9;
	public static final int UNICHAIN = 10;
	public static final int DETMULTI = 11;
	// Built-in function names
	public static final String names[] = { "min", "max", "floor", "ceil", "round", "pow", "mod", "log", "multi", "mlessmulti", "unichain", "detmulti"};
	// Min/max function arities
	public static final int minArities[] = { 2, 2, 1, 1, 1, 2, 2, 2, 1, 1, 1, 1};
	public static final int maxArities[] = { -1, -1, 1, 1, 1, 2, 2, 2, -1, -1, -1, -1};
	...
	public static boolean isMLessMulti(Expression expr) {
		return expr instanceof ExpressionFunc &&  ((ExpressionFunc)expr).getNameCode() == ExpressionFunc.MLESSMULTI;
	}
}
