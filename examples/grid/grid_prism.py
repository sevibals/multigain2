...
def generate_grid(size):
    with open("grid{}.prism".format(str(size)), "w") as file:
        grid_size = size**2
        ...
        for i in range(0,grid_size):
            ...
            #right_action
            target_dict = dict()
            target_dict[state_right] = target_dict.get(state_right, 0.0) + 0.8
            target_dict[state_up] = target_dict.get(state_up, 0.0) + 0.1
            target_dict[state_down] = target_dict.get(state_down, 0.0) + 0.1
            action = "\t[right{}] state={} -> ".format(str(i), str(i))
            for key, value in target_dict.items():
                action += "{}: (state'={}) + ".format(str(value), str(key))
            file.write(action[:-3] + ";\n")
            
            #down_action
            target_dict = dict()
            target_dict[state_down] = target_dict.get(state_down, 0.0) + 0.8
            target_dict[state_left] = target_dict.get(state_left, 0.0) + 0.1
            target_dict[state_right] = target_dict.get(state_right, 0.0) + 0.1
            ...
            #left_action
            target_dict = dict()
            target_dict[state_left] = target_dict.get(state_left, 0.0) + 0.8
            target_dict[state_up] = target_dict.get(state_up, 0.0) + 0.1
            target_dict[state_down] = target_dict.get(state_down, 0.0) + 0.1
            ...
            #up_action
            target_dict = dict()
            target_dict[state_up] = target_dict.get(state_up, 0.0) + 0.8
            target_dict[state_left] = target_dict.get(state_left, 0.0) + 0.1
            target_dict[state_right] = target_dict.get(state_right, 0.0) + 0.1
